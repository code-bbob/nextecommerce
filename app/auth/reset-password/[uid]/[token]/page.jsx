...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await customFetch(`/api/auth/reset-password/${uid}/${token}/`, {
        method: "POST",
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-slate-800 p-4">
      ...
      >
        ...
        >
          <Link href="/auth/login" className="text-blue-400 hover:text-blue-300 transition-colors flex items-center">
