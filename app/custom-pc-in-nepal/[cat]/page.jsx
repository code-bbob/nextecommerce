      ...
      <div className="flex-grow flex md:flex-row flex-col">
        ...
        <aside className="hidden md:block md:w-64">
          <div className="sticky top-0 h-screen overflow-y-auto">
            <Suspense
              fallback={
                <div className="text-white p-4">Loading filters...</div>
              }
            >
              <FilterSidebar
                category={category}
        ...
        <main className="flex-1 p-4 md:p-8">
          <div className="flex justify-between md:justify-center items-center mb-6">
            <h1 className="text-2xl md:text-2xl font-extrabold text-white capitalize">
          ...
          <Suspense
            fallback={<div className="text-white">Loading products...</div>}
          >
