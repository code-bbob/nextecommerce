...
export default function HeroSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-white via-gray-50 to-gray-100"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex absolute top-0 items-center gap-3 bg-gradient-to-r from-red-600/90 to-orange-600/90 backdrop-blur-sm text-white rounded-full px-6 py-3 shadow-xl"
            >
              <motion.div
            ...
            <motion.div
              ...
              className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 shadow-xl"
            >
                ...
                <div className="text-right">
                  <div className="bg-red-600 text-white rounded-lg px-4 py-2">
                    <div className="text-2xl font-black">
                      {featuredProduct.savingsPercent}%
                    </div>
            ...
            >
              {[
                ...
                },
                {
                  ...
                  subtext: "International coverage",
                },
                {
                  icon: CreditCard,
                  text: "0% EMI Available",
                  subtext: "Up to 24 months",
                },
                {
                  icon: Trophy,
                ...
                <motion.div
                  ...
                  className="bg-white/80 backdrop-blur-sm border border-gray-200 rounded-xl p-4 hover:bg-white/90 hover:shadow-lg transition-all duration-300"
                >
          ...
          >
            ...
            <div className="relative my-4">
              {/* Futuristic glow */}
              <div className="absolute -inset-8 bg-gradient-to-r from-blue-500/10 via-cyan-500/15 to-blue-600/10 rounded-3xl blur-3xl animate-pulse" />

              {/* Main product card */}
              <motion.div
                whileHover={{ y: -12, rotateY: 3 }}
                transition={{ type: "spring", stiffness: 300, damping: 30 }}
                className="relative bg-white/95 backdrop-blur-2xl border border-gray-200 rounded-3xl p-8 shadow-2xl hover:shadow-3xl"
              >
                {/* Stock urgency */}
                <div className="absolute top-6 left-6 z-20">
                  <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white rounded-2xl px-4 py-2 shadow-xl">
                    ...
                    <div className="text-sm font-black">
                      Only {featuredProduct.inStock} Left
                    </div>
                  </div>
                </div>
                ...
                <div className="relative mb-8 mt-8">
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-100/50 to-gray-200/30 rounded-2xl" />
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <Button
                      variant="outline"
                      className="border-2 border-gray-300 text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-400 rounded-xl py-4 font-semibold"
                    >
                      Quick Buy
                    </Button>
                  </div>
