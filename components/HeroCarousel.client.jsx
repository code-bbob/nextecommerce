          ...
          <SwiperSlide key={index}>
            ...
            >
              ...
              <div className="w-full md:w-1/2 text-center md:text-left px-6">
                ...
                <p className="mt-4 md:mt-16 text-xl md:text-2xl text-gray-300">
                  Get the best <span className="text-purple-600 whitespace-nowrap text-2xl font-bold">New Year 2082 Deals</span> on{" "}
