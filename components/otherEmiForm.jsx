...
const OtherForm = ({ product }) => {
  ...
  const [applicantDocs, setApplicantDocs] = useState({
    ...
    salaryCreditBankStatement: null,
  });
  ...
  return (
    <form onSubmit={handleSubmit} className="p-3">
      ...
      <div className="grid md:grid-cols-8 gap-4">
        <div className=" hidden md:block space-y-4 col-span-3">
        ...
        {currentStep === 1 && (
          <Card className="col-span-5 bg-inherit h-full text-white border border-white p-4">
          ...
          <Card className="bg-inherit col-span-5 text-white border border-white p-4">
            ...
            <fieldset className="border p-4 rounded mt-4">
              <legend className="font-semibold px-2">
                Applicant Documents (The legal age requirement is above 20 years
                old)
              </legend>
              <div className="grid md:grid-cols-3 gap-4">
                <div>
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-4">
                ...
                <div>
                  <label className="block text-sm font-medium">
                    Salary Credit Bank Statement
                  </label>
                  <input
                    type="file"
                    name="salaryCreditBankStatement"
                    accept="image/*"
                    onChange={handleApplicantFileChange}
                    required
                    className="mt-1 block w-full p-2 border rounded"
        ...
        {currentStep === 3 && (
          <Card className="col-span-5 bg-inherit text-white border border-white p-4">
            ...
            <fieldset className="border p-4 rounded mt-4">
              <legend className="font-semibold px-2">
                Documents (The legal age requirement is above 20 years old)
              </legend>
              <div className="grid md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium">
