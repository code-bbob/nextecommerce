                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
                    {displayBanners.slice(0, 2).map((banner) => (
                        <Link href={banner.link} key={banner.id} className="block">
                            <div className="relative rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 h-48 bg-gray-100">
